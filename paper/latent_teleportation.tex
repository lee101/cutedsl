...
We evaluate two families of guesser: a learned \emph{latent walker} with a
...
analysis harness, ablations over draft length and forecaster family, three grids
...
The aggregate timing result is negative, but it does not answer the more useful
question of \emph{how} each approximation fails. Figures~\ref{fig:method-style},
